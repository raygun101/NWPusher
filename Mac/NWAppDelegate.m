...
{
    _config[@"payload"] = _payloadField.string;
...
{
    _payloadField.string = @"{\"aps\":{\"alert\":\"Testing.. (0)\",\"badge\":1,\"sound\":\"default\"}}";
}
...
- (void)updatePayloadCounter
{
    ...
    NSError *error = nil;
    BOOL isJSON = !![NSJSONSerialization JSONObjectWithData:[payload dataUsingEncoding:NSUTF8StringEncoding] options:0 error: &error];
...
- (void)loadConfig
{
    ...
    _config = [NSMutableDictionary dictionaryWithContentsOfURL:url];
